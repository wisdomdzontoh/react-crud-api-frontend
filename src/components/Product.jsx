...
const Product = ({ product, getProducts }) => {
    ...
    const deleteProduct = async (id) => {
        ...
        if(result.isConfirmed){
            try{
                await axios.delete(`${VITE_BACKEND_URL}/products/${id}`); // Corrected the API endpoint URL
        ...
        <div className="bg-white rounded shadow-lg overflow-hidden">
            ...
            <div className="px-4 pt-2 pb-4">
                ...
                <div className="mt-2 flex gap-4">
                    <Link to={`/edit/${product._id}`} className="inline-block w-full text-center shadow-md text-sm bg-purple-700 text-white rounded-sm px-4 py-1 font-bold hover:bg-gray-600 hover:cursor-pointer">Edit</Link>
